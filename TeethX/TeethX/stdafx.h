...
//_____________________________________________ Windows XP
#define WINVER 0x0501
#define _WIN32_WINNT 0x0502
//_____________________________________________ Windows Vista
...
#define CONNECTION_STRING L"DRIVER={SQL Server};server=ISRAELLSMT_M\\SQLEXPRESS;database=dental;Trusted_Connection=yes"