...
protected:
	...
	void InitializeGui()
	{
		...
		customControl3.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE, 111, 312, 46, 77, hWnd, 1005);
		customControl4.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE, 159, 312, 46, 77, hWnd, 1006);
		...
		customControl12.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE, 552, 312, 46, 77, hWnd, 1014);
		...
		customControl19.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE, 111, 391, 46, 77, hWnd, 1021);
		customControl20.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE, 159, 391, 46, 77, hWnd, 1022);
		...
		customControl28.Create(WS_EX_CLIENTEDGE, NULL, WS_CHILD | WS_TABSTOP | WS_VISIBLE, 552, 391, 46, 77, hWnd, 1030);
